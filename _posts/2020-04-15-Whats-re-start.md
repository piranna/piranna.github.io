...
The different templates had the same or similar files duplicated between them,
which made maintenance more difficult. `react-native-cli` doesn't support using
